...
<script type="application/ld+json">{"@context":"https://schema.org","@type":["Organization","AdvertisingAgency"],"@id":"https://www.diessemedia.it/#organization","name":"Diesse Media","legalName":"Diesse Media SRL","url":"https://www.diessemedia.it/","logo":"https://www.diessemedia.it/assets/logo.png","image":"https://www.diessemedia.it/assets/og-cover.jpg","email":"info@diessemedia.it","description":"Centro media specializzato in comunicazione outdoor: pianificazione affissioni, maxi affissioni, arredo urbano e digital in Campania e in tutta Italia.","telephone":"+39 081 18253788","vatID":"IT09646331216","areaServed":[{"@type":"AdministrativeArea","name":"Campania"},{"@type":"Country","name":"Italia"}],"memberOf":{"@type":"Organization","name":"Consorzio LOOH","alternateName":"Local Out Of Home","url":"https://www.looh.it/"},"openingHoursSpecification":[{"@type":"OpeningHoursSpecification","dayOfWeek":["Monday","Tuesday","Wednesday","Thursday","Friday"],"opens":"09:00","closes":"13:00"},{"@type":"OpeningHoursSpecification","dayOfWeek":["Monday","Tuesday","Wednesday","Thursday","Friday"],"opens":"14:30","closes":"18:00"}],"address":{"@type":"PostalAddress","streetAddress":"Viale Olimpico 5","addressLocality":"Casandrino","addressRegion":"NA","postalCode":"80025","addressCountry":"IT"}}</script>
<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
