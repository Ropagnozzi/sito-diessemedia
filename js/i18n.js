...
(function () {
  var DICTS = {
    en: {
      ...
      'net.looh.desc': 'Founding member of the Local Out Of Home consortium, which brings together 11 local billboard concessionaires that own their sites: direct coverage across Italy.',
    ...
    zh: {
      ...
      'net.looh.role': '全国联盟',
      'net.looh.desc': 'Local Out Of Home 联盟的创始成员——该联盟汇集 11 家拥有自有媒体资源的本地户外广告特许经营商，实现覆盖全意大利。',
