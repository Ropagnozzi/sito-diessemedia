...
(function () {
  var DICTS = {
    en: {
      'ring.ac.t': 'America\'s Cup in Naples',
      'ring.ac.d': 'Get noticed on the large formats during the event',
      'ac.meta.title': 'America\'s Cup in Naples 2026–2027 — Large-Format Billboards to Get Noticed | Diesse Media',
      'ac.meta.desc': 'The Louis Vuitton 38th America\'s Cup races in the Gulf of Naples. Millions of eyes on the city: own the Diesse Media large-format sites and turn the event into visibility for your brand.',
      'ac.pill': 'Naples · International event 2026–2027',
      'ac.h1': 'The America\'s Cup lights up Naples.<br>Your brand can light up <em>with us.</em>',
      'ac.lead': 'The most prestigious sailing event on the planet — the Louis Vuitton 38th America\'s Cup — comes to Italy for the first time, racing in the Gulf of Naples under the gaze of Vesuvius. For months, millions of Italian and international eyes will be on the city. It\'s the perfect moment to <strong>get noticed</strong>.',
      'ac.cta1': 'Book your large-format site',
      'ac.cta2': 'See the large formats',
      'ac.slot1.k': 'Happening now · 2026',
      'ac.slot1.d': 'Louis Vuitton Preliminary Regatta',
      'ac.slot1.p': '24–27 September 2026 · Lungomare Caracciolo, Rotonda Diaz — Gulf of Naples',
      'ac.slot2.k': 'The main event · 2027',
      'ac.slot2.d': 'Louis Vuitton Cup & Match',
      'ac.slot2.p': 'Match from 10 July, final 17–18 July 2027 · team bases in Bagnoli',
      'ac.s1.eyebrow': 'What is the America\'s Cup',
      'ac.s1.h2': 'The oldest trophy in sport, in Italy for the first time',
      'ac.s1.p1': 'Born in 1851, the America\'s Cup is the oldest and most prestigious event in sailing: a true <strong>“Formula 1 of the sea”</strong>. In 2027, for the first time in its history, the Louis Vuitton Cup and the Match will be sailed in Italy — in the Gulf of Naples.',
      'ac.s1.p2': 'On the water, the flying boats: the <strong>AC75</strong> and <strong>AC40</strong> foiling monohulls racing at over 90 km/h, with Vesuvius as a backdrop. Naples is no stranger to this stage: the 2012 and 2013 America\'s Cup World Series drew <strong>over a million spectators</strong> to the seafront.',
      'ac.s1.p3': '<strong>Racing for the Cup:</strong>',
      'ac.team.nz': '🇳🇿 Emirates Team New Zealand (Defender)',
      'ac.team.it': '🇮🇹 Luna Rossa Prada Pirelli',
      'ac.team.gb': '🇬🇧 INEOS Britannia',
      'ac.team.ch': '🇨🇭 Alinghi',
      'ac.team.us': '🇺🇸 American Magic',
      'ac.team.fr': '🇫🇷 France',
      'ac.team.au': '🇦🇺 Australia',
      'ac.s2.eyebrow': 'Why it matters for your brand',
      'ac.s2.h2': 'When the world looks at Naples, it looks at its streets too',
      'ac.s2.c1t': 'International spotlight',
      'ac.s2.c1d': 'Media from around the world, sailing fans, delegations, global sponsors and high-end tourism: for months Naples is at the centre of international attention. A showcase a city gets only a few times in a generation.',
      'ac.s2.c2t': 'A city that fills up',
      'ac.s2.c2d': 'The seafront, historic centre, access routes and neighbourhoods fill with visitors on the move. A huge, qualified and curious audience — exactly where out-of-home advertising performs best.',
      'ac.s2.c3t': 'Local + national together',
      'ac.s2.c3d': 'Being seen in Naples during this period means speaking to those experiencing the event on site and, at the same time, riding the national media wave that shines a light on the city.',
      'ac.s3.eyebrow': 'The reason why',
      'ac.s3.h2': 'Large formats: the medium that catches every eye',
      'ac.s3.p1': 'When a city fills with eyes, <strong>out-of-home</strong> is the only medium that reaches them all: it can\'t be switched off, skipped or blocked by any ad-blocker. It\'s there, large, for entire days, in front of everyone passing on foot or by car.',
      'ac.s3.p2': 'Our <strong>large-format sites</strong> command the busiest arteries of Naples — Via Marina, Via Diocleziano, Via Foria and the routes towards the centre and the seafront: exactly the flows the America\'s Cup multiplies. Getting noticed here, now, means turning the event\'s attention into real visibility for your brand.',
      'ac.s3.li1': 'Maximum impact on facades and buildings in key positions',
      'ac.s3.li2': 'Coverage of high-traffic streets towards the seafront and centre',
      'ac.s3.li3': 'Map-based planning with catchment areas and population reached',
      'ac.s3.li4': 'Photo report of completed posting, site by site',
      'ac.s3.cap': 'Large format 7×10 · Via Marina, Naples',
      'ac.st1n': '1st ever',
      'ac.st1l': 'America\'s Cup in Italy',
      'ac.st2l': 'Event windows in Naples (2026 &amp; 2027)',
      'ac.st3l': 'Teams racing for the Cup',
      'ac.st4n': '1M+',
      'ac.st4l': 'Spectators in Naples in 2012–13',
      'ac.cta.h2': 'The stage is set. All that\'s missing is your brand.',
      'ac.cta.p': 'The best sites for the America\'s Cup period are limited and go fast. Book your large-format sites in Naples now: we\'ll prepare the map, positions and quote.',
      'ac.cta.btn': 'Book the large-format sites',
      'nav.home': 'Home',
      'nav.servizi': 'Services',
      'nav.maxi': 'Large Formats',
      'nav.allestimenti': 'Fit-outs',
      ...
      'footer.serv.allest': 'Fit-outs & wraps',
      ...
      'net.eyebrow': 'Network & partnerships',
      'net.title': 'A network that multiplies our reach',
      'net.intro': 'We don’t work alone: we’re part of a network of Out of Home specialists, to give you wider coverage and deeper expertise.',
      'net.looh.role': 'National consortium',
      'net.looh.desc': 'We are part of the LOOH consortium, which brings together the best billboard concessionaires — owners of their own sites — in the major cities: direct coverage across Italy.',
      'net.looh.link': 'Visit looh.it ↗',
      'net.cam.role': 'EAV stations',
      'net.cam.desc': 'We work with the exclusive concessionaire for advertising in EAV stations and trains: a 300 km network, from central Naples to Pompeii and Sorrento.',
      'net.cam.link': 'Visit campaniamedia.it ↗',
      'net.sm.role': 'Mid-size formats · Naples',
      'net.sm.desc': 'Partner specialised in mid-size billboard formats in Naples, for fine-grained, targeted coverage of the city.',
      'net.soon': 'Website coming soon',
      'mx.hero.eyebrow': 'Large Formats',
      'mx.hero.h1': 'Impossible<br>to ignore.',
      'mx.hero.lead': 'Large surfaces on facades, scaffolding and rooftops: communication that dominates the skyline and turns a building into your stage.',
      'mx.hero.explore': 'Explore the sites',
      'mx.v1.t': 'Dominates the skyline',
      'mx.v1.d': 'A presence no other format can match: your brand becomes part of the urban landscape.',
      'mx.v2.t': 'Impossible to skip',
      'mx.v2.d': 'No scroll, no skip. The large format imposes itself on everyone who passes, every day.',
      'mx.v3.t': 'Perfect for launches & brands',
      'mx.v3.d': 'The go-to tool for product launches, corporate campaigns and major image operations.',
      'mx.patr.eyebrow': 'The inventory',
      'mx.patr.h2': 'The large-format sites, one by one',
      'mx.patr.intro': 'Explore our large-format positions: filter by city or type and open each site to see its dimensions, lighting and visibility.',
      'mx.f.city': 'City',
      'mx.f.type': 'Type',
      'mx.map.h3': 'Where they are, on the map',
      'mx.map.p': 'The same sites, geolocated. Click a marker for photos and details. The filters above apply to the map too.',
      'mx.scale.eyebrow': 'Sense of scale',
      'mx.scale.h2': 'How big is a large format?',
      'mx.scale.p': 'A large-format site can exceed 6 metres in height: taller than a bus, many times a person. Hard to go unnoticed.',
      'mx.scale.brand': 'YOUR BRAND',
      'mx.scale.maxi': 'LARGE FORMAT &middot; 6 m',
      'mx.scale.bus': 'Bus &middot; 3.2 m',
      'mx.scale.person': 'Person &middot; 1.8 m',
      'mx.proc.eyebrow': 'How a large format is made',
      'mx.proc.h2': 'From the site to the banner on the street',
      'mx.s1.t': 'Site survey',
      'mx.s1.d': 'We find the right position for your goals and budget, with visibility and traffic data.',
      'mx.s2.t': 'Graphic adaptation',
      'mx.s2.d': 'We adapt your creative to the large format, so it reads perfectly from a distance.',
      'mx.s3.t': 'Large-format printing',
      'mx.s3.d': 'Professional printing on suitable, weather-resistant materials.',
      'mx.s4.t': 'Installation & check',
      'mx.s4.d': 'Specialised teams install the site; we send you the photo report.',
      ...
      'mx.lb.pdf': 'View presentation (PDF)',
      'mx.pdf.close': 'Close',
      'mx.pdf.closeAria': 'Close presentation',
      ...
      'ring.allest.t': 'Fit-outs',
      'ring.allest.d': 'Wraps, windows, stands and events',
      ...
      'home.method.photo': 'Map planning screenshot with isochrones<br>(assets/foto/home-pianificazione.jpg)',
      ...
      'imp.gallery.eyebrow': 'Sites',
      'imp.gallery.title': 'Sites and coverage',
    ...
    zh: {
      'ring.ac.t': '那不勒斯美洲杯',
      'ring.ac.d': '赛事期间在大型广告牌上脱颖而出',
      'ac.meta.title': '2026–2027 那不勒斯美洲杯 — 用大型广告牌脱颖而出 | Diesse Media',
      'ac.meta.desc': '路易威登第38届美洲杯将在那不勒斯湾举行。全城汇聚百万目光：占据 Diesse Media 的大型广告位，把这场盛事转化为你的品牌曝光。',
      'ac.pill': '那不勒斯 · 国际赛事 2026–2027',
      'ac.h1': '美洲杯点亮那不勒斯。<br>你的品牌，也能<em>与我们一同闪耀。</em>',
      'ac.lead': '全球最负盛名的帆船赛事——路易威登第38届美洲杯——首次来到意大利，在维苏威火山的注视下于那不勒斯湾展开角逐。数月之间，意大利与全球的百万目光都将聚焦这座城市。正是<strong>脱颖而出</strong>的最佳时刻。',
      'ac.cta1': '预订你的大型广告位',
      'ac.cta2': '查看大型广告',
      'ac.slot1.k': '正在进行 · 2026',
      'ac.slot1.d': '路易威登预备赛',
      'ac.slot1.p': '2026年9月24–27日 · 卡拉乔洛海滨、Rotonda Diaz — 那不勒斯湾',
      'ac.slot2.k': '重头戲 · 2027',
      'ac.slot2.d': '路易威登杯与决赛',
      'ac.slot2.p': '决赛自7月10日起，7月17–18日收官（2027年）· 各队基地设于 Bagnoli',
      'ac.s1.eyebrow': '美洲杯是什么',
      'ac.s1.h2': '体育史上最古老的奖杯，首次登陆意大利',
      'ac.s1.p1': '美洲杯始于1851年，是帆船运动中最古老、最负盛名的赛事，堆称<strong>“海上的一级方程式”</strong>。2027年，路易威登杯与决赛将史上首次在意大利举办——就在那不勒斯湾。',
      'ac.s1.p2': '水面之上是“飞行”的赛船：<strong>AC75</strong> 与 <strong>AC40</strong> 单体帆船凭水翼以超过90公里/小时的速度飞驰，维苏威火山为背景。那不勒斯对此并不陌生：2012与2013年的美洲杯世界系列赛曾吸引<strong>逾百万观众</strong>涌向海滨。',
      'ac.s1.p3': '<strong>逐鹿美洲杯：</strong>',
      'ac.team.nz': '🇳🇿 新西兰酋长队（卫冕方）',
      'ac.team.it': '🇮🇹 Luna Rossa Prada Pirelli（意大利）',
      'ac.team.gb': '🇬🇧 INEOS Britannia（英国）',
      'ac.team.ch': '🇨🇭 Alinghi（瑞士）',
      'ac.team.us': '🇺🇸 American Magic（美国）',
      'ac.team.fr': '🇫🇷 法国',
      'ac.team.au': '🇦🇺 澳大利亚',
      'ac.s2.eyebrow': '为何对你的品牌至关重要',
      'ac.s2.h2': '当世界注视那不勒斯，也在注视它的街道',
      'ac.s2.c1t': '国际聚光灯',
      'ac.s2.c1d': '来自世界各地的媒体、帆船爱好者、各国代表团、全球赞助商与高端游客：数月之间，那不勒斯将成为国际关注的中心。这是一座城市几代人才会遇到几次的舞台。',
      'ac.s2.c2t': '人潮涌动的城市',
      'ac.s2.c2d': '海滨、历史中心、主要通道与各个街区都将挤满流动的访客。庞大、优质而好奇的受众——正是户外广告最能发挥作用的场景。',
      'ac.s2.c3t': '本地与全国同时触达',
      'ac.s2.c3d': '在此期间于那不勒斯亮相，既能触达现场亲历赛事的人群，又能借助聚焦这座城市的全国媒体热潮。',
      'ac.s3.eyebrow': '核心理由',
      'ac.s3.h2': '大型广告牌：捕捉每一道目光的媒介',
      'ac.s3.p1': '当一座城市汇聚无数目光，<strong>户外媒体</strong>是唯一能触达所有人的媒介：无法关闭、无法跳过，也没有任何广告拦截器能阻挡。它就在那里，尺幅巨大，日复一日，面向每一位步行或驾车经过的人。',
      'ac.s3.p2': '我们的<strong>大型广告位</strong>坐落于那不勒斯人流最密集的主干道——Via Marina、Via Diocleziano、Via Foria 以及通往市中心与海滨的轴线：正是美洲杯所倍增的人流。此时此地脱颖而出，就是把赛事的关注度转化为你品牌的真实曝光。',
      'ac.s3.li1': '在关键点位的建筑立面上实现最大冲击力',
      'ac.s3.li2': '占据通往海滨与市中心的高流量街道',
      'ac.s3.li3': '基于地图的规划，覆盖辐射范围与触达人口',
      'ac.s3.li4': '逐块广告位的上刊照片报告',
      'ac.s3.cap': '大型广告 7×10 · Via Marina，那不勒斯',
      'ac.st1n': '首次',
      'ac.st1l': '美洲杯在意大利',
      'ac.st2l': '那不勒斯的赛事窗口（2026 与 2027）',
      'ac.st3l': '逐鹿美洲杯的队伍',
      'ac.st4n': '100万+',
      'ac.st4l': '2012–13年那不勒斯观众',
      'ac.cta.h2': '舞台已就绪，只差你的品牌。',
      'ac.cta.p': '美洲杯期间的优质广告位数量有限、抢订迅速。立即预订你在那不勒斯的大型广告位：我们将为你准备地图、点位与报价。',
      'ac.cta.btn': '预订大型广告位',
      'nav.home': '首页',
      'nav.servizi': '服务',
      'nav.maxi': '大幅面',
      'nav.allestimenti': '布展搭建',
      'nav.impianti': '媒体与覆盖',
      'nav.chisiamo': '关于我们',
      'nav.contatti': '联系我们',
      'nav.cta': '索取报价',
      ...
      'net.eyebrow': '网络与合作',
      'net.title': '放大覆盖的合作网络',
      'net.intro': '我们并非单打独斗：我们是一个户外广告(OOH)专业企业网络的一员，为您带来更广的覆盖与更强的专业能力。',
      'net.looh.role': '全国联盟',
      'net.looh.desc': '我们是 LOOH 联盟的成员——该联盟汇集各大城市最优秀、拥有自有媒体资源的户外广告特许经营商，实现覆盖全意大利的直接投放。',
      'net.looh.link': '访问 looh.it ↗',
      'net.cam.role': 'EAV 车站',
      'net.cam.desc': '我们与 EAV 车站及列车广告位的独家特许经营商合作：300 公里线路网，从那不勒斯市中心直达庞贝与索伦托。',
      'net.cam.link': '访问 campaniamedia.it ↗',
      'net.sm.role': '中幅面 · 那不勒斯',
      'net.sm.desc': '专注于那不勒斯中幅面招贴广告的合作伙伴，实现对城市的精细化精准覆盖。',
      'net.soon': '网站即将上线',
      'mx.hero.eyebrow': '大幅面',
      'mx.hero.h1': '无法<br>忽视。',
      'mx.hero.lead': '楼宇立面、脚手架与楼顶上的大型广告面：主导城市天际线，让一栋建筑成为你的舞台。',
      'mx.hero.explore': '浏览媒体点位',
      'mx.v1.t': '主导天际线',
      'mx.v1.d': '其他版式无法企及的存在感：让你的品牌成为城市景观的一部分。',
      'mx.v2.t': '无法被跳过',
      'mx.v2.d': '没有滑动、没有跳过。大幅面每天都会闯入每一位路人的视线。',
      'mx.v3.t': '新品与品牌的理想之选',
      'mx.v3.d': '产品发布、企业形象与大型形象工程的首选媒介。',
      'mx.patr.eyebrow': '媒体资源',
      'mx.patr.h2': '大幅面点位，逐一呈现',
      'mx.patr.intro': '浏览我们的大幅面点位：按城市或类型筛选，点开每个点位查看尺寸、照明与可见度。',
      'mx.f.city': '城市',
      'mx.f.type': '类型',
      'mx.map.h3': '在地图上的位置',
      'mx.map.p': '同样的点位，已地理定位。点击标记查看照片与详情。上方的筛选同样作用于地图。',
      'mx.scale.eyebrow': '尺度感',
      'mx.scale.h2': '大幅面有多大？',
      'mx.scale.p': '一个大幅面点位高度可超过 6 米：比公交车更高，是人身高的数倍。很难不被注意到。',
      'mx.scale.brand': '你的品牌',
      'mx.scale.maxi': '大幅面 &middot; 6 米',
      'mx.scale.bus': '公交车 &middot; 3.2 米',
      'mx.scale.person': '行人 &middot; 1.8 米',
      'mx.proc.eyebrow': '大幅面如何诞生',
      'mx.proc.h2': '从选点到上墙',
      'mx.s1.t': '实地勘察',
      'mx.s1.d': '结合可见度与车流数据，为你的目标和预算找到合适的位置。',
      'mx.s2.t': '图形适配',
      'mx.s2.d': '将你的创意适配到大幅面，确保远距离也清晰完美。',
      'mx.s3.t': '大幅面印刷',
      'mx.s3.d': '在耐候的专用材料上进行专业印刷。',
      'mx.s4.t': '安装与核验',
      'mx.s4.d': '专业团队完成安装，并向你发送照片报告。',
      'mx.cta.h2': '想为你的品牌拿下一个大幅面吗？',
      'mx.cta.p': '告诉我们目标、城市与时段：我们将提供合适的点位、报价与交互式仪表板。',
      'mx.lb.cta': '申请此点位',
      'mx.lb.pdf': '查看方案（PDF）',
      'mx.pdf.close': '关闭',
      'mx.pdf.closeAria': '关闭方案',
      ...
      'home.method.photo': '地图规划模拟截图（含等时圈）<br>(assets/foto/home-pianificazione.jpg)',
      ...
      'imp.gallery.eyebrow': '媒体位',
      'imp.gallery.title': '媒体位与覆盖',
